...
import 'viewmodels/vendor_cars_edit_viewmodel.dart';

class VendorCarsEditArgs {
  final int carId;

  const VendorCarsEditArgs(this.carId);
}

class VendorCarsEditPage extends StatefulWidget {
  @override
  _VendorCarsAddPageState createState() => _VendorCarsAddPageState();
}

class _VendorCarsAddPageState extends State<VendorCarsEditPage> {
  late VendorCarsEditArgs args;
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      context.read(vendorCarsEditViewModel(args.carId)).fetchCar();
    });
  }

  @override
  Widget build(BuildContext context) {
    args = ModalRoute.of(context)!.settings.arguments as VendorCarsEditArgs;
      ...
      child: Scaffold(
        ...
        body: Consumer(
          builder: (context, watch, child) {
            final vm = watch(vendorCarsEditViewModel(args.carId));

            return vm.carState.when(
